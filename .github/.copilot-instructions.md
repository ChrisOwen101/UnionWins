# Union Wins - AI Agent Instructions
...
This is a monorepo containing a **React + TypeScript frontend** (Vite) and a **Python FastAPI backend**. The application tracks trade union victories and uses OpenAI's Deep Research API to automatically discover new union wins.
...
- Research uses `o4-mini-deep-research` model with `background=True` and `web_search_preview` tool
