...
- After all changes, run `./lint_and_build.sh` to ensure both frontend and backend pass linting and build steps.
...
- Use ./lint_and_build.sh to run linters for both frontend and backend
...
- Use Tailwind CSS 4 for all styling in the frontend
- Use a consistent colour scheme (gray-scale with orange accents)
